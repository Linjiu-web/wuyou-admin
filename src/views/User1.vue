    ...
    <div class="user-container">
        ...
        <div class="userDialog">
            <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="50%">
                <el-form :model="formModel" :rules="rules" class="myform" :inline="true" ref="myform"
                    label-width="100px">
        ...
        <div class="common-table">
            <el-table stripe height="90%"
                :data="filterDataShow.slice((currentPage - 1) * pageSize, currentPage * pageSize)" style="width: 100%"
                highlight-current-row border fit :default-sort="{ prop: 'id' }">
